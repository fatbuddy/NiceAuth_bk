...
/**
 * Setup and Maintenance Console for NiceAuth Plugin
 *
...
class NiceAuthShell extends AppShell {
	...
	public function db_init() {
		...
		$this->User->create();
		$this->User->save(array('username' => 'admin', 'email' => 'admin@example.com', 'password' => 'pass1234', 'repeat_password' => 'pass1234', 'group_id' => 1));
